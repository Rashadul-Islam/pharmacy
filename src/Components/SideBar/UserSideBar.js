    ...
    return (
        <div>
            <IconContext.Provider value={{ color: '#fff' }}>
                <div className='navbar-top d-flex justify-content-between pb-3 pt-3'>
                    <Link to='#' className='menu-bars px-3'>
                        <FaIcons.FaBars onClick={showSidebar} />
                    </Link>
                    <p className='text-white px-4 pt-3'>{Role}<span className="signOut" onClick={handleSignOut}><span><FaIcons.FaSignOutAlt /></span> SignOut</span></p>
                </div>
